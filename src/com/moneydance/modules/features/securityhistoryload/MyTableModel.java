...
public class MyTableModel extends DefaultTableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 2:
			...
			return  Main.cdate.format(iDate);
			/*
		...
		case 4:
			...
			if (!mapDates.containsKey(strTicker))
				return "unknown";
			return  Main.cdate.format(mapDates.get(strTicker).intValue());
			/*
			 * Last Price
			 */
		case 5:
		...
		case 6:
			 ...
			 */
		case 7:
			if (objParms.getHigh().equals(Parameters.strDoNotLoad))
				return " ";
			strKey = listPrices.get(rowIndex).getKey();
			 ...
			 */
		case 8:
			if (objParms.getLow().equals(Parameters.strDoNotLoad))
				return " ";
			strKey = listPrices.get(rowIndex).getKey();
			 ...
			 */
		default:
			if (objParms.getVolume().equals(Parameters.strDoNotLoad))
				return " ";
			strKey = listPrices.get(rowIndex).getKey();
