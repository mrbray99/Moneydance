...
public class DetailedFileDisplayWindow extends JPanel implements
	...
	public static final SimpleDateFormat DT_FMT = new SimpleDateFormat(
			"yyyy-MM-dd");
	/*
	...
	static {
		nodetypes = new HashMap<Integer, Account.AccountType>();
	...
	static {
		accounttypes = new HashMap<Account.AccountType, String>();
	...
	public DetailedFileDisplayWindow(
			...
			boolean includeBudgetsp, boolean includeCurrenciesp,
			boolean includeMemorizedItemsp, boolean includeRemindersp,
			boolean includeAllTransp,
			boolean includeTransbyAccountsp, int txtStartDatep,
			int txtEndDatep) {
	...
	public void reset(boolean includeBankAccountsp,
			boolean includeInvestmentsp, boolean includeAssetsp,
			boolean includeCreditCardsp, boolean includeLiabilitiesp,
			boolean includeLoansp, boolean includeSecuritiesp,
			boolean includeIncomecatp, boolean includeExpensecatp,
			boolean includeAddressBookp, boolean includeBudgetsp,
			...
			int txtStartDatep, int txtEndDatep) {
		this.includeBankAccounts = includeBankAccountsp;
		this.includeInvestments = includeInvestmentsp;
		this.includeAssets = includeAssetsp;
		this.includeCreditCards = includeCreditCardsp;
...
//				* LEVELSCROLLPANE, SCROLLPANEDEPTH));
	...
	private void displayextras(myNodeObject userobj, Integer nodeid,
		...
		case '1':
			...
			Vector<String> vadsync = new Vector<String>();
		...
		case '3':
			...
			Vector<String> vbsync = new Vector<String>();
		...
		case '7':
			...
			if(lct.getCurrencyType()== CurrencyType.Type.SECURITY) {
				Vector<String> vctcurr = new Vector<String>();
		...
		case '6':
			...
			Vector<String> vrid = new Vector<String>();
			vrid.add("ID");
			...
			if (irm.length > 0) {
				...
				for (int i=0;i<irm.length  && i < 10;i++) {
					Vector<String> vrrmi = new Vector<String>();
			...
			if (irm.length > 0) {
				...
				for (int i=0;i<irm.length  && i < 10;i++) {
					Vector<String> vrrwdi = new Vector<String>();
			...
			Vector<String> vrTran = new Vector<String>();
	...
	private void displaybudgetitem(myNodeObject userobj, Integer nodeid,
		...
		Vector<String> vbisync = new Vector<String>();
