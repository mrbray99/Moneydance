...
public class SelectionPane extends ScreenPanel{
		...
		public SelectionPane(Parameters paramsp) {
			params = paramsp;
			setUpTable();
			Label selectionLbl = new Label("Data Selection Groups");
			selectionLbl.setTextAlignment(TextAlignment.CENTER);
			selectionLbl.setFont(Font.font("Veranda",FontWeight.BOLD,20.0));
			add(selectionLbl,0,0);
			setMargin(selectionLbl,new Insets(10,10,10,10));
			setColumnSpan(selectionLbl,4);
