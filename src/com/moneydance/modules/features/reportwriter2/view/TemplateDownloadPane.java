...
import com.moneydance.modules.features.reportwriter2.samples.HttpDownloadUtility;
import com.moneydance.modules.features.reportwriter2.view.controls.MyGridPane;
import com.moneydance.modules.features.reportwriter2.view.tables.TemplateListRow;
...
public class TemplateDownloadPane extends ScreenDataPane {
	/*
	...
	public TemplateDownloadPane(Parameters params) {
		super();
	...
	public void displayPanel() {
		...
		if (Platform.isFreeBSD() || Platform.isUnix())
			tempDirName += "/";
		Main.rwDebugInst.debug("TemplateDownloadPane", "downloadTemplates", MRBDebug.SUMMARY, "Downloading " + fileName);
		try {
			listFileName = HttpDownloadUtility.downloadFile(templateListFile, tempDirName);
			Main.rwDebugInst.debug("TemplateDownloadPane", "downloadTemplates", MRBDebug.SUMMARY, "File " + fileName + " downloaded");
		} catch (DownloadException e) {
			Main.rwDebugInst.debug("TemplateDownloadPane", "downloadTemplates", MRBDebug.INFO, "Error downloading " + fileName);
			throw e;
		} catch (IOException e) {
			Main.rwDebugInst.debug("TemplateDownloadPane", "downloadTemplates", MRBDebug.INFO, "IO Error downloading " + fileName);
