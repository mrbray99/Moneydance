...
public abstract class Utilities {
   public static final File getLauncherFile() {
	...
	public static Color webStringToColor(String webString) {
		return Color.valueOf(webString);
	}
	...
	public static double printerToScreen (double value) {
		return  (value/72.0)*25.4;
	}
	public static double screenToPrinter(double value) {
